...
def connectionCheck():
    try:
        ...
        s.connect(('www.google.com', 80)), print("<!!!ONLINE!!!>")
...
def Assistant():
    ...
    while True:
            ...
            # Opens CMD.
                ...
                os.startfile('C:\\Users\\Shrivanth\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\System Tools\\Command Prompt.exe')
            ...
            elif "outlook" in query or "microsoft outlook" in query:
            ...
            elif "open hot star" in query or "open hotstar" in query or "disney plus hotstar" in query or "disney + hotstar" in query or "disney+hotstar" in query:
